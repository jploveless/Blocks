function varargout = my_plot_google_map(xlim, ylim, varargin)
...
% This looks like a succesful call!
% close all; clear all; plot([0 360], [-80 80], '-r'); drawnow; set(gca, 'Xlim', [0 360], 'Ylim', [-80 80]); plot_google_map('Refresh', 0)
...
curAxis = axis;
curAxis = [xlim(1) xlim(2) ylim(1), ylim(2)];
