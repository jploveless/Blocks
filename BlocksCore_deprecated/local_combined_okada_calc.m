function [nue, nun, nuu, nstrain] = local_okada_calc(flong1, flat1, flong2, flat2, long, lat, fdip, fld, fss, fds, fts, nu, fbd)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                  %%
%%  local_okada_calc.m                              %%
%%                                                  %%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sliptype = {'S', 'D', 'T'};
sliptype = sliptype{find(fss fds fts)};
[ux, uy, uz, l, e] = Okada1992(bx, by, bz, [tfx tfy; tfxe tfye], deg2rad(fdip, [-fbd, -fld], 1, sliptype, 3e10, nu); 
