function WriteOutput(Segment, Patches, Station, Block, Command, Model, Strikes)
...
% Write out block motions
WriteBlocks(sprintf('.%s%s%sMod.block', filesep, runName, filesep), Block.name, Block.interiorLon, Block.interiorLat, Model.lonEuler, Model.lonEulerSig, Model.latEuler, Model.latEulerSig, Model.rateEuler./1e6, Model.rateEulerSig./1e6, ...
            Block.rotationInfo, Block.aprioriTog, zeros(numel(Model.lonEuler), 1), zeros(numel(Model.lonEuler), 1), zeros(numel(Model.lonEuler), 1), zeros(numel(Model.lonEuler), 1), zeros(numel(Model.lonEuler), 1), zeros(numel(Model.lonEuler), 1));
