function [G, tz, ts] = gGetTriPartials(Patches, Station)
% Calculate elastic partial derivatives for triangular elements on GPU

% Place necessary variables on GPU
stationlon                                     = gsingle(Station.lon);
stationlat                                     = gsingle(Station.lat);

patcheslon                                     = gsingle(Station.lon);
stationlat                                     = gsingle(Station.lat);
