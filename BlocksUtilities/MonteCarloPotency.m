function [fault, block, ratio, bstr2, bvols] = MonteCarloPotency(direc, n)
...
for i = 1:n
   S = s;
   S.eastVel = s.eastVel + noisee(:, i);
   S.northVel = s.northVel + noisen(:, i);
   WriteStation('Noisy.sta.data', S.lon, S.lat, S.eastVel, S.northVel, o.eastSig, o.northSig, S.corr, S.other1, S.tog, S.name);
   Blocks_dev(comn);
   resid2strain(newdir, {'rest_of_the_world', 'Indo_Austrailia', 'SouthEastAsia', 'BurmanRanges', 'Eurasia'}, 1, 0);
