...
[sta2.lon, sta2.z] = meshgrid(100.1:.01:101, -20:1:0);
sta2.lat = 25.5*ones(size(sta2.lon));
sta2.lon = sta2.lon(:); sta2.lat = sta2.lat(:); sta2.z = sta2.z(:);


% Segment
[seg.lon1, seg.lon2, seg.lat1, seg.lat2, seg.lDep, seg.dip, seg.bDep] = deal([100.1; 100.4; 100.6; 102.5], [100.5; 100.8; 101; 102.9], [50; 50; 50; 50], [0; 0; 0; 0], [15; 15; 15; 5], [90; 90; 90; 90], [0; 0; 0; 0]);
...
% Slips
segslips = [11; 0; -2; 0; 0; 2; 0; 0; 3; 32; 0; -13];
