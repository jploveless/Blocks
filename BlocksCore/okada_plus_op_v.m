function [uxtot, uytot, uztot] = okada_plus_op_v(xf, yf, strike, d, delta, L, W, U1, U2, U3, xs, ys, Pr)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                        %%
%%  okada_plus_op_v.m          
%%                                                                        %%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  uxtot           = ux(:, 1) - ux(:, 2) - ux(:, 3) + ux(:, 4);
  uytot           = uy(:, 1) - uy(:, 2) - uy(:, 3) + uy(:, 4);
  uztot           = uz(:, 1) - uz(:, 2) - uz(:, 3) + uz(:, 4);
