...
[sta2.lon, sta2.z] = meshgrid(100.01:.001:100.7, -20:1:0);
sta2.lat = 25.1*ones(size(sta2.lon));
sta2.lon = sta2.lon(:); sta2.lat = sta2.lat(:); sta2.z = sta2.z(:);


% Segment
[seg.lon1, seg.lon2, seg.lat1, seg.lat2, seg.lDep, seg.dip, seg.bDep] = deal([100.1; 100.3], [100.3; 100.6], [27; 25], [25; 23.6], [15; 15], [90; 90], [0; 0]);
